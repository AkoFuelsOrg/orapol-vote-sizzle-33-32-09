...
const CreateMarketplaceModal: React.FC<CreateMarketplaceModalProps> = ({ isOpen, onClose, asSheet = false }) => {
  ...
  // If asSheet is true, we're rendering the content directly inside a Sheet component
  // so we don't need the Dialog wrapper
  if (asSheet) {
    return (
