...
import { Loader2, ChevronDown, Sparkles, BarChart } from 'lucide-react';
...
const Vibezone: React.FC = () => {
  ...
  const convertJsonToPollOptions = (jsonOptions: Json): any[] => {
  ...
  const allContent = [...posts, ...polls].sort((a, b) => 
        ...
        {loading ? (
          ...
          <Card className="overflow-hidden border-none shadow-lg p-8 text-center bg-gradient-to-br from-white to-gray-50">
            ...
            <Button 
              ...
              style={{ display: 'none' }} // Added inline style to hide the button
            >
            ...
            <div 
              ...
              style={{ display: 'none' }} // Added inline style to hide the message
            >
              Post a poll in Vibezone
            </div>
          </Card>
        ) : (
