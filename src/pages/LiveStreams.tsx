...
const LiveStreams: React.FC = () => {
  ...
  return (
    <div className="container mx-auto pt-6 pb-10 px-4 md:px-8">
      ...
      {liveStreams.length === 0 ? (
        <Card className="p-8 text-center bg-gray-50">
          ...
          <p className="text-gray-500 mb-4">There are no live streams at the moment.</p>
          <Button 
            onClick={() => navigate('/live/new?host=true')}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {liveStreams.map(stream => (
            ...
            >
              ...
              <div className="p-4">
                <h3 className="font-medium text-lg mb-1 line-clamp-1">{stream.title}</h3>
                <p className="text-sm text-gray-600 mb-2">Hosted by {stream.hostName}</p>
